...
C
C
C MODIFIED TO TAKE INPUT FROM A FILE FORMATTED AS FOLLOWS -
C YEAR, MONTH, DAY, HOUR, RNDAY
C MODIFIED BY JAMAL KHAN - JAMAL.KHAN@LEGOS.OBS-MIP.FR
C TO COMPILE IFORT/GFORTRAN -O TIDEFAC TIDE_FAC.F
C THE FORMAT OF TIDEFACINPUT IS FOLLOWING -
C YEAR,MONTH,DAY,HOUR,RNDAY
C FOR INSTANCE A RUN STARTING FROM 2007/11/12 00Z FOR 3.9 DAYS THE TIDEFACINPUT
c FILE WILL CONTAIN - YEAR,MONTH,DAY,HOUR,RNDAY
      ...
      OPEN(UNIT=12,FILE='tidefacinput',STATUS='OLD')
      READ(12,*) IYR,IMO,IDAY,BHR,XDAYS
      ...
      WRITE(11,10) IYR,IMO,IDAY,BHR
      WRITE(*,10) IYR,IMO,IDAY,BHR
  10  FORMAT(I4,',',I2,',',I2,',',F5.2)
      WRITE(*,11) XDAYS
      WRITE(11,11) XDAYS
  11  FORMAT(F5.2)
